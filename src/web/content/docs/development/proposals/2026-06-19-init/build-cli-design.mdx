...
**Related:** [Anime Series Data Model](/docs/development/proposals/2026-06-19-init/data-model-anime-series) ·
[Characters & Staff Data Model](/docs/development/proposals/2026-06-19-init/data-model-characters-staff) — the schema this tool produces.
...
- **Characters & Staff source → Wikidata (CC0).** It's the one major source that's *freely
  ...
  iteration — see the [Characters & Staff Data Model](/docs/development/proposals/2026-06-19-init/data-model-characters-staff).)
